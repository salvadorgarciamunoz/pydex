...
def make_designer(TIC, verbose=0):
    ...
    d.ti_controls_names = ["T", "t_rxn", "cat_mol", "boron_eq", "base_eq"]
    d.response_names = ["yield_P", "imp_D", "res_B"]
...
d2.ti_controls_names = ["T", "t_rxn", "cat_mol", "boron_eq", "base_eq"]
d2.response_names = ["yield_P", "imp_D", "res_B"]
...
d3.ti_controls_names = ["T", "t_rxn", "cat_mol", "boron_eq", "base_eq"]
d3.response_names = ["yield_P", "imp_D", "res_B"]
